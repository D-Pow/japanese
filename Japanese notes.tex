...
% 照れる
% 乳首
% お持ち帰り = takeout (food), e.g. お持ち帰りで３つお願いします (I'd like 3 to-go please)
% 飽きる = to get bored
% ほど = as _ as, e.g. 君ほど甘くない = not as sweet as you
% さもないと不思議な人になる。
% おとぎ話のようなもの。
% 正直
% 信頼する
...
% 成り行きで
% 惚れる
% 見よくありますか (do I look good (attractive)?)
...
\tab{Things to do}{
\furi{支払い}{shi harai}   &   \makecell[l]{payment method \\ (e.g. when asked which to use) }     \\\hline
...
\furi{つもり}{tsumori}         &   intention   \\\hline
}
...
\ul{
    ...
    \item \kana{すっきりした} = \q{I feel refreshed/how refreshing!}
    ...
    \item \furi{いつも ５時 に 仕事 が 終わります}{itsumo goji ni shigoto ga owarimasu} = \q{I always finish working at 5}
...
\kana{ところで}      &   by the way \\\hline
\kana{とりあえず}        &   for now  \\\hline
}
...
\furi{一番好き}{ichiban suki}   &   favorite    \\\hline
\furi{行きつけ}{ikitsuke}   &   favorite place  \\\hline
}
...
\furi{泊まる}{tomaru}      &   \makecell[l]{to stay (at) \\ e.g. for a trip, at friend's house}    \\\hline
}
...
\furi{酔う}{you}      &   to be drunk (e.g. \Furi[I'm drunk]{酔って いる}{yotte iru})  \\\hline
...
\furi{構う}{kamau}    &   \makecell[l]{to pay attention to \\ (e.g. pay attention to me) }     \\\hline
\furi{泣く}{naku}     &   to cry      \\\hline
\furi{構う}{kamau}    &   \makecell[l]{to care (about)
                            \\ e.g. \Furi[I don't mind]{構わない}{kamawanai}}  \\\hline
\furi{騙す}{damasu}   &   to deceive  \\\hline
